...
int choice;
    do {
        ...
        switch (choice) {
            case 1:
                printf("Regula Falsi Yöntemi sonucu: %lf\n", regula_f());
                break;
            case 2:
                printf("Aralýk Yarýmlama Yöntemi sonucu: %lf\n", aralik_y());
                break;
            case 3:
                printf("Newton Raphson Yöntemi sonucu: %lf\n", newton_r());
                break;
            case 4:
                printf("Gauss Yoketme Yöntemi sonucu: %f\n", yoketme_gauss());
                break;
            case 5:
                printf("Gauss-Seidel Yöntemi sonucu: %f\n", gauss_seidal());
                break;
            case 6:
                printf("Trapez Yöntemi sonucu: %f\n", trapez_y());
                break;
            case 7:
                printf("Simpson Yöntemi sonucu: %f\n", simpson_y());
                break;
            case 0:
...
void display_menu() {
    printf("Menu:\n");
    printf("1. Regula Falsi Yontemi\n");
    printf("2. Aralik Yarimlama Yontemi\n");
    printf("3. Newton Raphson Yontemi\n");
    printf("4. Gauss Yoketme Yontemi\n");
    printf("5. Gauss-Seidel Yontemi\n");
    printf("6. Trapez Yontemi\n");
    printf("7. Simpson Yontemi\n");
    printf("0. Cikis\n");
